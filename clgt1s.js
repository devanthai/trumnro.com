...
server.listen(6999, () => console.log('Server Running on port 6999'));
...
auto = async () => {
    try {
        ...
        if (cookies == null) {
            ...
            await page.type("#phoneOrEmail", 'zok1234');
            await page.type("#password", '759900');
        ...
        if (content.includes("10,000,000")) {
            ...
            for (var i = 1; i < data[0].length; i++) {
                ...
                if (sotien > 0) {
                    ...
                    if (!findGt1s) {
                        await new Gachthe1s({ magd: magd, sotien: sotien, timegt1s: time, noidung: noidung, status: -1, name: "null", tienthang: -1, vangthang: -1 }).save()
                    }
                }
