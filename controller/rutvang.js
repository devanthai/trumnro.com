            ...
            if (user) {
                ...
                if (user.vang < gold2) {
                    ...
                    if (upgold.username === user.username && (user.vang - upgold.vang == gold2)) {
                        ...
                        //         bot.sendMessage(-591908464, "Thằng này không nạp tiền")
                        //     }
                        //     bot.sendMessage(-591908464, user.username + "\nCLTX: " + cuocs + " , Keno: " + cuockenos + " , TX: " + cuoctxs + "\nNạp tiền: " + numberWithCommas(user.topup) + "\nTổng ngày: " + numberWithCommas(user.thanhtichngay) + "\nSố vàng rút: " + numberWithCommas(gold2) + "\nSố dư: " + numberWithCommas(soduu.vang) + "\nNgày tạo acc: " + new Date(user.date).toLocaleString() + " \nServer: " + user.server)
                        // } catch { }
